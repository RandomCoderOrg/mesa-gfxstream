...
3. Correctly handle Present serial wrap and abrupt X connection teardown under
   repeated stress. Synchronous and live window loss, resize, and
   retired-swapchain replacement now pass deterministic gates.
